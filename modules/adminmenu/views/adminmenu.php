...
class adminmenuViewBup extends viewBup {
    ...
    public function initMenu() {
        ...
        $subMenuTabs = array(
			...
			6 => array('parentSlug' => $this->_file, 'pageTitle' => __('Featured Plugins', BUP_LANG_CODE), 'capability' => $accessCap, 'menuSlug' => 'admin.php?page=supsystic-backup&tab=featured-plugins'),
        );
