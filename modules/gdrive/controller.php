...
class gdriveControllerBup extends controllerBup {
    ...
    /**
     * Save Credentials And Begin Authentication Action
     *
     * @since  1.1
     */
    public function beginAuthenticationAction() {
        ...
        $model->saveCredential('clientId', $request['client_id']);
        $model->saveCredential('clientSecret', $request['client_secret']);

        $response->addData(array('authUrl' => $model->getAuthenticationURL()));
